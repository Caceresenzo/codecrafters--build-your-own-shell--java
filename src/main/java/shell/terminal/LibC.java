...
public interface LibC extends Library {
	...
	public final int ISIG = 1;
	public final int IEXTEN = 100000;
	public final int OPOST = 1;
	public final int IXON = 2000;
...
//			return "struct_termios[c_iflag=" + c_iflag + ", c_oflag=" + c_oflag + ", c_cflag=" + c_cflag + ", c_lflag=" + c_lflag + ", c_line=" + c_line + ", c_cc=" + Arrays.toString(c_cc) + "]";
		}
